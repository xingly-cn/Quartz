...
import com.sugar.quartz.utils.job.HelloTriggerListener;
import com.sugar.quartz.utils.listener.MyTriggerListener;
import org.quartz.*;
 ...
 */
public class HelloTriggerListenerDemo {
    public static void main(String[] args) throws SchedulerException {
        // 1、调度器 - 从工厂获取调度实例
        Scheduler scheduler = StdSchedulerFactory.getDefaultScheduler();

        // 2、任务实例 - 执行的任务对象
        JobDetail job = JobBuilder.newJob(HelloTriggerListener.class)
